...
create table tb_score (valores float8, movie_id int8 not null, usuario_id int8 not null, primary key (movie_id, usuario_id));
...
alter table if exists tb_score add constraint FKtlnqlcd1kmiupogmcbsxe5ux5 foreign key (usuario_id) references tb_usuario;
...
INSERT INTO tb_score(movie_id, usuario_id, valores) VALUES (1, 1, 5.0);
INSERT INTO tb_score(movie_id, usuario_id, valores) VALUES (1, 2, 4.0);
INSERT INTO tb_score(movie_id, usuario_id, valores) VALUES (2, 1, 3.0);
INSERT INTO tb_score(movie_id, usuario_id, valores) VALUES (2, 2, 3.0);
INSERT INTO tb_score(movie_id, usuario_id, valores) VALUES (2, 3, 4.0);
